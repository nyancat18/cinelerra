...
echo "añadiendo dependencias"
  ...
  yum -y install nasm libavc1394-devel libusb-devel flac-devel \
    ...
    libsndfile-devel libtheora-devel linux-firmware ivtv-firmware http://archives.fedoraproject.org/pub/fedora/linux/releases/21/Everything/x86_64/os/Packages/y/yasm-1.2.0-7.fc21.x86_64.rpm
